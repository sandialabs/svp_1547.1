<scriptConfig name="CRP_FIX" script="CRP">
  <params>
    <param name="crp.q_max_abs_value" type="int">-1</param>
    <param name="crp.q_max_inj_value" type="int">1</param>
    <param name="crp.pf_response_time" type="float">10.0</param>
    ...
    <param name="eut.p_rated" type="float">6000.0</param>
    ...
    <param name="crp.q_max_abs_enable" type="string">Enabled</param>
    <param name="crp.half_q_max_inj_enable" type="string">Enabled</param>
    <param name="crp.v_in_nom" type="string">Enabled</param>
    <param name="crp.q_max_inj_enable" type="string">Enabled</param>
    <param name="crp.half_q_max_abs_enable" type="string">Enabled</param>
    <param name="eut_crp.sink_power" type="string">No</param>
    <param name="crp.imbalance_fix" type="string">No</param>
    <param name="eut.phases" type="string">Split phase</param>
  </params>
</scriptConfig>
