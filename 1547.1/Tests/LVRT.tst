<scriptConfig name="LVRT" script="VRT">
  <params>
    ...
    <param name="vrt.model_name" type="string">C:/...</param>
    <param name="vrt.cat_3_ena" type="string">Disabled</param>
