<scriptConfig name="WV_MANUAL" script="WV">
  <params>
    <param name="eut_wv.test_1_t_r" type="float">1.0</param>
    <param name="eut_wv.test_3_t_r" type="float">1.0</param>
    ...
    <param name="eut_wv.test_2" type="string">Disabled</param>
    <param name="eut_wv.test_3" type="string">Disabled</param>
    ...
    <param name="eut_wv.test_1" type="string">Enabled</param>
