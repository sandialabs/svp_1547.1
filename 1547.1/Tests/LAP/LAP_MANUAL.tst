<scriptConfig name="LAP_MANUAL" script="LAP">
  <params>
    <param name="lap.iter" type="int">1</param>
    <param name="fw.test_1_tr" type="float">1.0</param>
    <param name="vw.test_1_tr" type="float">1.0</param>
    ...
    <param name="lap.act_pwr" type="string">66%</param>
