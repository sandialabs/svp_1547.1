<scriptConfig name="VW_2" script="VW">
  <params>
    <param name="vw.test_2_tr" type="float">90.0</param>
    <param name="eut.efficiency_100" type="float">96.9</param>
    <param name="eut.efficiency_66" type="float">97.0</param>
    <param name="eut.efficiency_20" type="float">97.0</param>
