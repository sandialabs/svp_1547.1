<scriptConfig name="VRT_CATII" script="VRT">
  <params>
    ...
    <param name="vrt.two_phase_value_1" type="string">A</param>
    <param name="vrt.two_phase_value_2" type="string">B</param>
    ...
    <param name="gridsim_1.mode" type="string">Disabled</param>
    <param name="gridsim_1.auto_config" type="string">Disabled</param>
    <param name="gridsim_2.mode" type="string">Disabled</param>
    ...
    <param name="vrt.three_phase_mode" type="string">Enabled</param>
